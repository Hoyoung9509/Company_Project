...
<div class="portal-content">
    <h2 class="page-title">통합 검색</h2>
    <p class="page-subtitle">공지사항, 채용, 서비스 정보를 검색합니다</p>

    <form action="/portal/search" method="get" class="portal-search-form">
                        ...
                        <div class="search-item">
                            <div class="search-item-header">
                                <span class="badge badge-type">
                                    <c:choose>
                                        <c:when test="${item.type == 'NOTICE_INTERNAL'}">사내공지</c:when>
                            ...
                            <h3 class="search-title">
                                <c:choose>
                                    <c:when test="${item.type == 'NOTICE_INTERNAL'}">
                                        <a href="/portal/notice/${item.id}">${item.title}</a>
                                    </c:when>
